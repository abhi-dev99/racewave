...
class _StrategyScreenState extends State<StrategyScreen>
  ...
  void initState() {
    ...
    _waveController = AnimationController(
      duration: const Duration(seconds: 8), // Gentle waves
      vsync: this,
    )..repeat();
    
    _particleController = AnimationController(
      duration: const Duration(seconds: 12), // Smooth particle motion
      vsync: this,
    )..repeat();
  }
  ...
  Widget _buildStrategyOverview() {
    return Container(
      margin: const EdgeInsets.all(24), // Better margins
      child: GlassmorphicContainer(
        width: double.infinity,
        height: 220, // Increased for no overflow
  ...
  Widget _buildTyreStrategySection() {
    return Container(
      ...
      child: GlassmorphicContainer(
        width: double.infinity,
        height: 380, // Increased for no overflow
        borderRadius: 25,
        blur: 20,
        alignment: Alignment.center,
        border: 2,
  ...
  Widget _buildSetupSection() {
    return Container(
      ...
      child: GlassmorphicContainer(
        width: double.infinity,
        height: 300, // Increased for no overflow
        borderRadius: 25,
        blur: 20,
        alignment: Alignment.center,
        border: 2,
  ...
  Widget _buildSimulationSection() {
    return Container(
      ...
      child: GlassmorphicContainer(
        width: double.infinity,
        height: 200, // Increased for no overflow
        borderRadius: 25,
        blur: 20,
        alignment: Alignment.center,
        border: 2,
